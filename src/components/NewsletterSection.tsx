        ...
        <div className="w-full lg:w-1/2">
          <form className="flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-4">
              ...
              <button 
                type="submit"
                className="px-8 py-4 rounded-lg bg-[#E0DDF7] text-[#594ad2] font-bold text-sm sm:text-base hover:bg-white transition-colors duration-200 shadow-lg whitespace-nowrap"
              >
                Subscribe
              </button>
            </div>
            ...
            <div className="flex items-center gap-3 ml-1">
              ...
              <div className="relative flex items-center">
                ...
                >
                  <path d="M1 4L3.5 6.5L9 1" stroke="#594ad2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
